...
const seclectCountry = document.getElementById('seclect_country');
const checkboxvl = document.getElementById('checkbox_vl');

const emailEnter = document.getElementById('email_enter');
const phoneEnter = document.getElementById('phone_enter');
const countryEnter = document.getElementById('country_enter');
const agreeEnter = document.getElementById('agree_enter');